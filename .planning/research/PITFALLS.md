...
**Prevention:** Implementierung von asynchronen "Filler Words" oder "Audio-Status-Updates" im Agenten _bevor_ der MCP-Call an Frappe abgesetzt wird (z.B. "Einen Moment, ich schlage das im System nach...").
